...
import { Eye, EyeOff, Mail, Lock, LogIn, Users, Guitar } from 'lucide-react';
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl shadow-blue-500/15 ring-1 ring-sky-100 dark:ring-slate-700 p-6 md:p-8 transition-colors duration-300">
            ...
            <div className="space-y-3">
                ...
                <button
                    onClick={handleGuest}
                    disabled={loading}
                            className="w-full bg-cyan-500 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded-lg transition disabled:opacity-50 flex items-center justify-center gap-2"
                >
